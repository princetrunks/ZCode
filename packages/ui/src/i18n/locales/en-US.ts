...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like Sando to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let Sando remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting Sando",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen Sando.",
  ...
  "startup.global.starting_services": "Starting Sando",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "Sando will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another Sando or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen Sando. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen Sando to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen Sando.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a Sando restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into Sando",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to Sando and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to Sando",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to Sando",
  "login.description": "Connect your account to start using Sando",
  ...
  "logout.confirm.title": "Disconnect and restart Sando?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only Sando Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About Sando",
  ...
  "forceUpdate.title": "Update Sando to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart Sando to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the Sando CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "Sando checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the Sando terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While Sando is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the Sando installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching Sando task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by Sando",
  ...
  "resourceManager.storage.diskUsage": "Sando uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the Sando desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Sando could not verify its Windows secure import component. Reinstall or update Sando before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, Sando will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by Sando Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "Sando provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This Sando Agent cannot refresh OAuth status. Upgrade or restart Sando, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to Sando to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into Sando",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to Sando 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by Sando automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in Sando.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. Sando uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in Sando after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "Sando MCP",
  ...
  "sidebar.usage.plan.mcp": "Sando MCP",
  "sidebar.usage.plan.zcodeMcp": "Sando MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for Sando built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into Sando. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. Sando follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into Sando",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by Sando Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend Sando with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into Sando and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. Sando follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into Sando",
  ...
  "settings.commands.description":
    "Manage Sando Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "Sando Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into Sando. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. Sando follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into Sando",
  ...
  "settingsSync.action.finish": "Start using Sando",
  "settingsSync.agent.zcode": "Sando Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current Sando settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to Sando",
  ...
  "onboarding.welcome.title": "Welcome to Sando",
  "onboarding.welcome.start": "Start Sando",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while Sando imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "Sando will copy {source} to {target}.\nIf the target file already exists, the Sando default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask Sando anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask Sando anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, Sando will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want Sando to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart Sando app and retry, or ask Sando to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with Sando in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for Sando: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with Sando in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current Sando Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'Sando MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No Sando MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "Sando",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Sando Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while Sando is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task Sando can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Sando Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "Sando Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart Sando",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart Sando to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified Sando plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "Sando will verify the Computer Use tools against the exact session when your first session starts.",
