...
function ZCodeStartupLogo({
  ...
  // Sando: the torii mark replaces the ZCode "Z" glyph on the startup badge (2026-09-21).
  return (
    <img
      src={sandoMarkUrl}
      alt=""
      aria-hidden="true"
      draggable={false}
      className={cn("shrink-0 select-none object-contain", animated ? "animate-pulse" : "", className)}
    />
  );
}
